...
${state === 'category_extraction' ? 'User described an issue. Be CREATIVE and INTELLIGENT - classify it into Healthcare, Infrastructure, Education, Security, or Other. Think outside the box - understand context, synonyms, and user intent. If unclear, ask friendly clarifying questions. Do NOT mention submission - we are just collecting information.' : ''}
${state === 'category_interpretation' ? 'User is selecting a category. Be CREATIVE and INTELLIGENT - understand numbers, names, natural language, context, and intent. Classify intelligently into Healthcare, Infrastructure, Education, Security, or Other. Think outside the box. Do NOT mention submission.' : ''}
${state === 'subcategory_interpretation' ? 'User is selecting a subcategory. Be CREATIVE and INTELLIGENT - understand numbers, names, natural language, and context. Match intelligently to available subcategories. Be flexible with matching. Do NOT mention submission.' : ''}
${state === 'category_error' ? 'User input doesn\'t match any category. Apologize briefly and encourage them to try again. Be friendly and helpful. Do NOT mention submission.' : ''}
${state === 'category_menu' ? 'Present issue categories in a friendly, conversational way. Tell users they can select by name or number. Be brief and engaging.' : ''}
${state === 'subcategory_menu' ? 'Present subcategories in a friendly, conversational way. Tell users they can select by name or number. Be brief and engaging.' : ''}
